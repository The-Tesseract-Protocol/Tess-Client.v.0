      ...
      <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-white/60">
            <p className="text-blue-400 font-medium mb-1">How Privacy Deposit Works</p>
            <ul className="space-y-1 text-white/50">
              <li>A unique hash (hashLN) is generated from ledger data</li>
              <li>Your deposit is linked to this hash, not your address</li>
              <li>Only you can withdraw using this hash</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      {generatedHashLN && (
        <div className="bg-white/5 border border-white/10 rounded-xl p-4">
          <label className="block text-xs font-medium text-white/40 mb-2">
            Your Deposit Hash (Save This!)
          </label>
          <div className="flex items-center gap-2">
            <code className="flex-1 font-mono text-sm text-green-400 bg-black/40 rounded px-3 py-2 overflow-x-auto">
              {generatedHashLN}
            </code>
            <button
              onClick={() => navigator.clipboard.writeText(generatedHashLN)}
